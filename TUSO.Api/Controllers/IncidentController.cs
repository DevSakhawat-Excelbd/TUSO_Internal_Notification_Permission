      ...
      public async Task<IActionResult> CreateIncident(Incident incident)
      {
         try
         {
            ...
            var incidentInDb = new Incident
            {
               ...
               UserAccountID = incident.UserAccountID,
            ...
            var incidentToReturn = await context.IncidentRepository.GetIncidentByKey(incidentInDb.OID);
