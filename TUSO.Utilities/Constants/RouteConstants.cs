...
namespace TUSO.Utilities.Constants
{
   public static class RouteConstants
   {
      ...
      public const string ReadNotifications = "notifications/{key}";

      //public const string ReadNotificationByKey = "notification/key/{key}";

      //public const string CreateNotification = "notification/{key}";

      public const string CreateNotification = "addNotification";

      //public const string CreateNotification = "notification";

      //public const string DeleteNotification = "notification/key";

      public const string MarkAllRead = "mark-all-read/{key}";

      public const string MarkAsRead = "mark-as-read/{key}";
      #endregion
      ...
      public const string UpdateApplicationPermission = "application-permission-update";
